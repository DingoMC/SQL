...
CREATE TABLE `faktura` (
  ...
  KEY `fk_faktura_zamowienie1_idx` (`idzamowienie`),
  CONSTRAINT `fk_faktura_zamowienie1` FOREIGN KEY (`idzamowienie`) REFERENCES `zamowienie` (`idzamowienie`)
...
INSERT INTO `faktura` VALUES (1,1),(2,3),(3,5);
